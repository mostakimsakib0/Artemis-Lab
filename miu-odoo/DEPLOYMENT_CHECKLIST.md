# MIU Software R&D Lab - Deployment Checklist
...
- [ ] 15-25 students ready (with emails)
...
- [ ] Clone repository (or setup miu-odoo folder)
  ```bash
...
- [ ] Verify containers running
  ```bash
  docker ps
  # Should show miu_odoo and miu_postgres
  ```
...
- [ ] Country: Bangladesh
- [ ] Language: English
- [ ] Company name: `MIU Software R&D Lab`
...
- [ ] Install **miu_custom** module
  - [ ] Enable Developer Mode
    - Go to Settings → Activate Developer Mode
  - [ ] Go to Apps → search "miu"
  - [ ] Install **MIU Custom Module**
...
- [ ] Email: `faculty@miu-rnd.lab`
- [ ] Name: Faculty Mentor Name
- [ ] Groups: Faculty Mentor + Development
- [ ] Save

**Create Project Manager User**
- [ ] Create user
- [ ] Email: `pm@miu-rnd.lab`
- [ ] Name: Project Manager Name
- [ ] Groups: Project Manager + Development
- [ ] Save

**Create Sample Students (5 minimum)**
- [ ] HR → Employees → Create
  - [ ] Name: Student 1 Name
  - [ ] Role Tag: Student
  - [ ] Batch: 2025
...
**End of Day:**
- [ ] 1 faculty user created & tested
- [ ] 1 PM user created
- [ ] 5 student employees created
- [ ] All users can login
...
- [ ] Add all 5+ students as team members
- [ ] Save
...
- [ ] Add to crontab
  ```bash
  crontab -e
  # Add: 0 2 * * * /path/to/miu-odoo/scripts/daily_backup.sh
  ```
...
**1. Student User**
- [ ] Create user: `student.test@miu-rnd.lab`
- [ ] Add to group: Student
- [ ] Login as this user
- [ ] Can they view tasks? ✓
...
**2. Developer User**
- [ ] Create user: `dev.test@miu-rnd.lab`
...
**3. Tech Lead User**
- [ ] Create user: `lead.test@miu-rnd.lab`
...
**5. Faculty Mentor User**
- [ ] Login as faculty (created on Day 3)
...
- [ ] Create subfolders:
  ...
  - [ ] Reports
  - [ ] Final
- [ ] Assign permissions (Faculty can delete)
...
- [ ] Check database integrity
  ```bash
  docker exec miu_postgres psql -U odoo -c "SELECT COUNT(*) FROM project_task;"
  ```
...
- [ ] Create login guide for students
  - [ ] How to access Odoo
...
- [ ] Faculty trained (30 min session)
- [ ] PM trained (30 min session)
- [ ] 2-3 students tested access
...
- [ ] Verify evaluation creation by faculty
...
1. ✅ 15+ students successfully login
2. ✅ Faculty can create & view evaluations
