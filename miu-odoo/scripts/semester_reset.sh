...
# MIU Software R&D Lab - Semester Reset Script
# This keeps database backup but resets project/task data
# Use before starting new semester/batch
# WARNING: This is destructive!

set -e

BACKUP_DIR="/path/to/miu-odoo/backups"
POSTGRES_CONTAINER="miu_postgres"
DB_USER="odoo"
DB_NAME="postgres"

echo "=========================================="
echo "MIU Semester Reset - DESTRUCTIVE OPERATION"
echo "=========================================="
echo ""
echo "This will:"
...
BACKUP_FILE="$BACKUP_DIR/db_semester_end_${TIMESTAMP}.sql"
...
# SQL Script to delete only semester data
SQL_RESET="
...
echo "[INFO] Ready to create new semester project"
echo ""
echo "Next steps:"
echo "1. Create new project for new batch"
echo "2. Assign students to new project"
